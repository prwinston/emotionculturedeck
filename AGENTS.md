...
AI-powered facilitation assistant that helps facilitators, leaders, and HR professionals design, run, and debrief Emotional Culture Deck sessions.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "201304425+prwinston@users.noreply.github.com"
  git config user.name "prwinston"
  ```
